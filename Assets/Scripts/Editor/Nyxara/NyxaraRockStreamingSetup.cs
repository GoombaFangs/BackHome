...
/// Rock / Rock2 / Rock3 / Rock4 only (excludes RockBlueRidgeFormation and other variants).
...
public static class NyxaraRockStreamingSetup
{
    ...
    const string RocksFolder = "Assets/Resources/Galaxy/Planets/Nyxara/Environment/Rock";
