...
/// setup but wires up <see cref="PlanetTreeStreamer"/> with Tree1..Tree5. TreeEmeraldCanopy and
/// TreeVerdantCrown are intentionally excluded (kept as hand-placed decoration, not part of the
/// streamed mix).
...
public static class NyxaraTreeStreamingSetup
{
    ...
    const string TreesFolder = "Assets/Resources/Galaxy/Planets/Nyxara/Environment/Trees";
