...
public static class NyxaraGrassScatter
{
    ...
    const string Grass4PrefabPath = GrassFolder + "/GrassLuminousToadstool.prefab";
    const string Grass5PrefabPath = GrassFolder + "/HollowLog.prefab";
    ...
    static string SetupStreaming()
    {
        ...
        if (grassPrefab == null || grass2Prefab == null || grass3Prefab == null || grass4Prefab == null || grass5Prefab == null)
        {
            string missingMessage =
                ...
                + $"GrassLuminousToadstool: {(grass4Prefab != null ? "OK" : "MISSING")}\n"
                + $"HollowLog: {(grass5Prefab != null ? "OK" : "MISSING")}";
        ...
        string resultMessage = $"Removed {removed} static grass objects.\n"
                                + (isNew ? "Added" : "Updated")
                                + " PlanetGrassStreamer on 'Streamers' (Grass/Grass2/Grass3/GrassLuminousToadstool/HollowLog) — grass now streams in near the player at runtime.";
