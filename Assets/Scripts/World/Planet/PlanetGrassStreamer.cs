...
/// assigned grass variants (Grass1 / Grass2 / Grass3 / GrassLuminousToadstool / HollowLog),
...
public class PlanetGrassStreamer : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (regionSet == null)
        {
            ...
            WarnIfPrefabMissing(grass4Prefab, "GrassLuminousToadstool");
            WarnIfPrefabMissing(grass5Prefab, "HollowLog");
        }
    ...
    void MigrateLegacyPrefabs()
    {
        ...
        const string grassFolder = "Assets/Resources/Galaxy/Planets/Nyxara/Environment/Grass";
        if (grass4Prefab == null)
            grass4Prefab = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>(grassFolder + "/GrassLuminousToadstool.prefab");
        if (grass5Prefab == null)
            grass5Prefab = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>(grassFolder + "/HollowLog.prefab");
#endif
    }
    ...
    static string NameFor(int prefabIndex)
    {
        switch (prefabIndex)
        {
            ...
            case Grass4Index: return "GrassLuminousToadstool";
            case Grass5Index: return "HollowLog";
